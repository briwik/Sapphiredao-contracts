...
contract MigrateDistributor is Policy {
    ...
    address public immutable sSapOld;
    
    address public newStaking;
    address public sSapNew;
    ...
    */
    ...
    constructor( address _treasury, address _inte, uint _epochLength, uint _nextEpochBlock, address _oldStaking, address _sSapOld, address _newStaking, address _sSapNew ) {
        ...
        require( _sSapOld != address(0) );
        sSapOld = _sSapOld;
        require( _newStaking != address(0) );
        newStaking = _newStaking;
        require( _sSapNew != address(0) );
        sSapNew = _sSapNew;
    ...
    function distribute() external returns ( bool ) {
        if ( nextEpochBlock <= block.number ) {
            ...
            uint oldReward= split(reward,ISINTE(sSapOld).circulatingSupply(),ISINTE(sSapNew).circulatingSupply());
    ...
    function setNewStaking(address _newStaking, address _sSapNew) external onlyPolicy() {
        require( _newStaking != address(0) );
        newStaking = _newStaking;
        require( _sSapNew != address(0) );
        sSapNew = _sSapNew;
